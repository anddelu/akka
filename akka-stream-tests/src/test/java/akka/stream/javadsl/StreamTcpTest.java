...
import akka.stream.ConnectionAttemptFailedException;
...
public class StreamTcpTest extends StreamTest {
  ...
  public void mustReportServerBindFailure() throws Exception {
    ...
    try {
      ...
      assertTrue("Expected BindFailedException, but other exception was reported:" + e, false);
    }
  }
  ...
  public void mustReportClientConnectFailure() throws Exception {
    ...
    // FIXME it is documented (as far as I can see) that a ConnectionAttemptFailedException is used, but it is a StreamTcpException   
    } catch (ConnectionAttemptFailedException e) { 
      // as expected
    } catch (StreamTcpException e) { 
      // as expected  
    } catch (Exception e) {
      assertTrue("Expected StreamTcpException, but other exception was reported:" + e, false);
    }
